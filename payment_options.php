...
$session_email = $_SESSION['cust_studEmail'];

$select_customer = "select * from customer2 where cust_studEmail='$session_email'";
...
<a style="text-decoration:none;"href="order.php?c_id=<?php echo $cust_id; ?>">Cash on Delivery</a>
