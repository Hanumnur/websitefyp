...
$query = "insert into cart (p_id,ip_add,qty,p_price,size) values ('$p_id','$ip_add','$product_qty','$pro_psp_price','$product_size')";
...
Price : <del> RM $pro_price </del><br>

Sale Price : RM $pro_psp_price
...
<button class="btnCart" type="submit" name="add_cart">
...
<a class="btn" style="margin-bottom:10px;" href="#description" data-toggle="tab"><!-- btn btn-primary tab Starts -->

<?php

if($status == "product"){

echo '<span style="font-size: 15px;"> '. '<span style="text-align: center;"> ' . "Description";
...
<a class="btnCart" style="margin-bottom:10px; text-decoration:none;" href="#features" data-toggle="tab"><!-- btn btn-primary tab Starts -->

Features

</a><!-- btn btn-primary tab Ends -->

<a class="btnCart" style="margin-bottom:10px; text-decoration:none; " href="#video" data-toggle="tab"><!-- btn btn-primary tab Starts -->
