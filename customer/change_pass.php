...
$sel_old_pass = "select * from customer2 where cust_password='$old_pass'";
...
$update_pass = "update customer2 set cust_password='$new_pass' where cust_studEmail='$c_studEmail'";
