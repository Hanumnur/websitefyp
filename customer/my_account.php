...
if(!isset($_SESSION['cust_studEmail'])){
...
$get_customer = "select * from customer2 where cust_studEmail='$c_studEmail'";

$run_customer = mysqli_query($con,$get_customer);

$row_customer = mysqli_fetch_array($run_customer);

$customer_confirm_code = $row_customer['cust_confirmCode'];

$c_name = $row_customer['cust_name'];
...
$update_customer = "update customers set customer_confirm_code='' where cust_confirmCode='$customer_confirm_code'";
