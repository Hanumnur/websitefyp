...
<i class="fa fa-dashboard" ></i> Dashboard / Add User
...
<label class="col-md-3 control-label">Seller's Details: </label>
...
<label class="col-md-3 control-label">Seller's Description: </label>
