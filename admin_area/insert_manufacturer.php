...
<i class="fa fa-dashboard"></i> Dashboard / Add Hostel
...
<i class="fa fa-money fa-fw"> </i> Add Hostel
...
<input type="submit" name="submit" class="form-control btn btn-primary" value=" Add Hostel " >
...
echo "<script>alert('New Hostel Has Been Inserted')</script>";
