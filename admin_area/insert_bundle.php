...
<i class="fa fa-dashboard"> </i> Dashboard / Add Service
...
<i class="fa fa-money fa-fw"></i> Add Service
...
Service's Url Example : proof-reading-apb
...
<a data-toggle="tab" href="#video"> YouTube Videos </a>
...
<label class="col-md-3 control-label" > Copy this link to
<br>  
...
<!-- The text field -->
<input type="text" value=" <iframe width=854 height=480 src=https://www.youtube.com/embed/qRswlmADRa8 frameborder=0 allowfullscreen></iframe>" 
...
<input type="submit" name="submit" value="Add Service" class="btn btn-primary form-control" >
