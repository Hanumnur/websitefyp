...
<i class="fa fa-dashboard"> </i> Dashboard / Add Items
...
<i class="fa fa-money fa-fw"></i> Add Items
...
<label class="col-md-3 control-label" > Item's Url </label>
...
Item's Url Example : lab-coat-uitm
...
<label class="col-md-3 control-label" > Item Sale Price </label>
...
<label class="col-md-3 control-label" > Item Tabs </label>
...
<a data-toggle="tab" href="#description"> Item Description </a>

</li>

<li>

<a data-toggle="tab" href="#features">Item Features </a>
