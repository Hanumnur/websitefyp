...
<i class="fa fa-dashboard"></i> Dashboard / Edit Hostel
...
<i class="fa fa-money fa-fw"> </i> Edit Hostel
...
<label class="col-md-3 control-label"> Show as Top Hostel </label>
...
<input type="submit" name="update" class="form-control btn btn-primary" value=" Update Hostel " >
...
echo "<script>alert('Hostel details Has Been Updated')</script>";
