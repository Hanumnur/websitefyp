...
<input type="text" class="form-control" name="c_studEmail" placeholder="Enter Your Email">
...
$sel_c = "select * from customer2 where cust_studEmail='$c_studEmail'";
